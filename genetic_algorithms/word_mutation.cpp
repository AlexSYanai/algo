...
static float randNum(float starting, float ending)
{
...
namespace Selection
{
  ...
  static float getFitness(std::string target_str, std::string candidate_str, int g_pop_size)
  { 
  ...
  static std::string mutate(std::string current_gen, float rate, int g_pop_size, std::string target)
  {
    float new_fitness;
